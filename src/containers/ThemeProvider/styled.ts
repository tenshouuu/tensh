...
export default createGlobalStyle`
    ...
    @font-face {
        ...
        src:
            url(../../assets/fonts/Roboto-Medium.woff) format('woff2'),
    ...
    @font-face {
        ...
        src:
            url(../../assets/fonts/Roboto-Bold.woff) format('woff2'),
    ...
    @font-face {
        ...
        src:
            url(../../assets/fonts/Roboto-Regular.woff) format('woff2'),
    ...
    body {
        margin: 0;
        min-height: 100vh;
        min-width: ${getMediaWidthByName('mobile')};
        font-family: RobotoRegular, -apple-system, BlinkMacSystemFont, "Roboto", sans-serif;
